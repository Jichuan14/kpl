  ...
  <main class="feature-space-page">
    <header class="feature-space-hero">
      <div>
        ...
        <p>
          {{ t("Each point is a hero's learned candidate representation after training. Nearby heroes are similar to the model in gameplay and ability-mechanics profiles as well as historical draft behavior.") }}
        </p>
      </div>
