"""PyTorch sequence-aware draft-choice models used by the POC.

Nothing in this module is imported by the production application.  It reads the
existing analysis exports but writes only beneath this POC directory.
"""
...
class DraftChoiceModel(nn.Module):
    """Shared embeddings and masked candidate scoring for every POC model."""
...
class BagAblationModel(DraftChoiceModel):
    """Order-insensitive control using the same POC embeddings."""
