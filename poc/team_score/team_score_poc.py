#!/usr/bin/env python3
"""Train, validate, and query an isolated hero-team matchup score POC."""
...
DEFAULT_ARTIFACT_DIR = POC_DIR / "artifacts"
...
MODEL_VERSION = "hero-team-score-poc-v1"
...
def rolling_validation(
    ...
    release_assessment = {
        ...
        >= 0.005,
        "reason": "The hero components add a small pooled gain, but it is below the POC's 0.005 material-improvement gate and is not stable in every held-out season.",
    }
    return {
...
def build_parser() -> argparse.ArgumentParser:
    ...
    train_parser = subparsers.add_parser("train", help="Train and validate the POC")
